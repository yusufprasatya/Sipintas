...
<div class="row">
    <div class="col s12 m9">
        <h3 class="orange-text">Laporan SPTB</h3>
    </div>
</div>
    ...
    <tbody>
        ...
        while ($data = mysqli_fetch_assoc($query)) { ?>
            <tr>
                ...
                <td><a class="btn modal-trigger green " href="index.php?p=detail-laporan-sptb&id_pengajuan=<?= $data['id_pengajuan'] ?>">Detail</a></td>
            </tr>
        <?php  }
        ?>
    </tbody>
